...
ActiveRecord::Schema.define(version: 20_150_604_123_249) do
  ...
  add_index 'categories_movies', %w(category_id movie_id), name: 'index_categories_movies_on_category_id_and_movie_id', unique: true, using: :btree
  ...
  add_index 'daily_statistics', %w(movie_id date), name: 'index_daily_statistics_on_movie_id_and_date', unique: true, using: :btree
